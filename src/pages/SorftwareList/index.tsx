...
import { Row, Col, DatePicker, Card, Table, Space, Button, Pagination, message, Modal, Tooltip, Form, InputNumber, Input, Tag, Select ,Upload} from 'antd';
import styles from './index.less'
import { useRequest, useIntl, history, useLocation } from 'umi'
import UserModel from './components/SorftwareModel'
import { ExclamationCircleOutlined, VideoCameraTwoTone, SearchOutlined,UploadOutlined } from '@ant-design/icons';
